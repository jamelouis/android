package io.github.jamelouis.travel_mate.travel.transport;
...
public class SelectModeOfTransport extends AppCompatActivity implements CardViewOptionsAdapter.OnItemClickListener {
    @BindView(R.id.transport_mode_options_recycle_view)    RecyclerView mTransportModeOptionsRecycleView;
    ...
    public void onItemClick(int position) {
        ...
        switch (position) {
            case 0:
                ...
                //startActivity(i);
                Toast.makeText(SelectModeOfTransport.this,"TrainList", Toast.LENGTH_LONG).show();
                break;
            case 1:
                //i = new Intent(SelectModeOfTransport.this, CarDirections.class);
                //startActivity(i);
                Toast.makeText(SelectModeOfTransport.this,"CarList", Toast.LENGTH_LONG).show();
                break;
        }
    }
}
